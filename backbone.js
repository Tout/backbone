...
let Backbone = {};
  ...
  _extend(Collection.prototype, Events, {
    ...
    sort: function(options) {
      ...
      if (_isFunction(comparator)) comparator = _bind(comparator, this);

      // Run sort based on type of `comparator`.
      if (length === 1 || _isString(comparator)) {
  ...
  _extend(Router.prototype, Events, {
    ...
    _bindRoutes: function() {
      ...
      this.routes = _result(this, 'routes');
      var route, routes = _keys(this.routes);
  ...
  var History = Backbone.History = function() {
    this.handlers = [];
    this.checkUrl = _bind(this.checkUrl, this);
  ...
  _extend(History.prototype, Events, {
    ...
    start: function(options) {
      ...
      this.options          = _extend({root: '/'}, this.options, options);
